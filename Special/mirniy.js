...
//inbox source
const SOURCE_ID = '61b4cc3c3eb94900088dfb21'
...
async function showHelp() {
	const html = mdToHtml(`
# Концепция развития Мирного

На карте можно предложить свои идеи и предложения по улучшению жизни в районе, или, наоборот, описать его актуальные проблемы.

Поделиться своим мнением просто:
- Нажмите кнопку «Добавить»
- Укажите место на карте, к которому относится ваш комментарий
- Выберите категорию вашего комментария: городская среда и озеленение, транспорт и дороги, экология и загрязнение, безопасность, жилье, социальная инфраструктура, образование, культура и сфера досуга, сохранение наследия и достопримечательности, работа
- Напишите ваш комментарий.

Количество отметок не ограничено. Чем больше жителей района выскажет свое мнение — тем более реализуемым и полезным для каждого жителя получится итоговый документ мастер-плана.
    `)
	await showPopup([
		['html', { html }]
	], {
