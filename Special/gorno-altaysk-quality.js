...
async function AddFeature() {
    ...
    const form = await requestInput([
        ['q1', ['number', { label: 'Общее состояние фасадов' }]],
        ['q2', ['number', { label: 'Общее состояние элементов фасадов' }]],
        ['q3', ['number', { label: 'Общее состояние территории' }]],
        ['q4', ['number', { label: 'Покрытие (ямы, волны, разрушения, сколы, следы ремонта)' }]],
        ['q5', ['number', { label: 'Оборудование (состояние элементов)' }]],
        ['q6', ['number', { label: 'Ограждения (перекошенность, ржавчина, вмятины, сколы, оголенность закладных)' }]],
        ['q7', ['number', { label: 'Освещение (перекошенность, ржавчина, вмятины, сколы, оголенность закладных)' }]],
        ['q8', ['number', { label: 'Озеленение (открытый грунт, болезни деревьев)' }]],
        ['q9', ['number', { label: 'Отвод воды (наличие работающей ливневой канализации)' }]],
        ['q10', ['number', { label: 'Актуальность представленного функционала' }]],
        ['q11', ['number', { label: 'Моральное состояние' }]],
        ['q12', ['number', { label: 'Общее ощущение' }]],
        // ['q13', ['number', { label: '' }]],
        // ['q14', ['number', { label: '' }]],
        // ['q15', ['number', { label: '' }]],
        // ['q16', ['number', { label: '' }]],
