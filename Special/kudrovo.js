...
Расскажите нам, каким вы видите будущее Заневки. Результаты лягут в основу предложений по развитию территорий.

Сбор мнений проводится c 20 апреля по 10 мая 2022 года.  Команда проекта: депутат Д.А. Кудинов при информационной поддержке unit4.io

Поделиться своим мнением просто: выберите то, о чем вы хотите рассказать, отметку (идея, проблема и ценность), затем укажите точку на карте и напишите свой комментарий во всплывающем окне, дополнительно вы можете выбрать категорию вашего комментария.

Мнение каждого важно, ведь так мы понимаем, как и чем живет сегодня Заневское городское поселение.
	`
	const md = new markdownit()
