...
const SOURCE_ID = '6221eb82ec292400094dad9a'
...
async function showHelp(){
	const text = `
# Исследование системы ценностей МО "Заневское городское поселение"

Расскажите, каким вы видите будущее Заневского муниципалитета ЛО. Результаты исследования лягут в основу предложений по развитию территорий.

Сбор мнений проводится по 15 мая 2022 года. Команда проекта: депутат Д.А. Кудинов при информационной поддержке unit4.io

Поделиться своим мнением просто: выберите то, о чем вы хотите рассказать (идея, проблема или ценность), затем укажите точку на карте и напишите свой комментарий во всплывающем окне, дополнительно вы можете выбрать категории для вашего комментария.

Мнение каждого важно, чтобы точно определить запросы жителей Заневского городского поселения.
	`
	const md = new markdownit()
