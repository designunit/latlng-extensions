...
const SOURCE_ID = '626ab0b5ed99e7000994b522'
...
async function showHelp(){
	const text = `
# Ульяновско-Димитровградская агломерация

Поделиться своим мнением просто:
1. Войдите с помощью социальных сетей (меню в правом верхнем углу)
2. Выберите отметку идею, проблему или ценность
3. Укажите место на карте, к которому относится ваш комментарий
4. Выберите категорию вашего комментария
5. Напишите ваш комментарий
	`
	const md = new markdownit()
