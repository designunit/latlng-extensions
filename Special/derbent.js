...
const LAYER_ID = '5f6d90a8e4cf7f5235dc6ef0'
...
3. Выберите категорию вашего комментария
4. Напишите ваш комментарий

**Идеи и предложения:** Как и с кем бы вы хотели здесь проводить время? Что может появиться на территории берегов реки Мелеузки от ул. Ленина до Центрального рынка для горожан?

**Проблемы:** Что вас беспокоит на территории берега реки Мелеузки, на рынке и автовокзале?

**Ценности:** Важные и любимые вами элементы, которые нужно сохранить или восстановить (исторические факты, события, архитектура, природа).
	`
    const md = new markdownit()
