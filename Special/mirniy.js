...
На карте можно предложить свои идеи по улучшению жизни в городе или, наоборот, описать актуальные проблемы.

Поделиться своим мнением просто:
- Нажмите кнопку «Добавить»;
- Укажите место на карте, к которому относится ваш комментарий;
- Выберите категорию вашего комментария: городская среда и озеленение, транспорт и дороги, экология, безопасность, жилье, социальная инфраструктура, образование, культура, спорт, досуг, сохранение наследия и достопримечательности, работа;
- Напишите ваш комментарий.

Количество отметок не ограничено. 
    `)
	await showPopup([
		['html', { html }]
	], {
