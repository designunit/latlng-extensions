...
На карте можно предложить свои идеи по улучшению жизни в городе, или, наоборот, описать его актуальные проблемы.
...
Количество отметок не ограничено. Чем больше жителей выскажет свое мнение — тем более реализуемым и полезным для каждого жителя получится итоговя концепция.
    `)
	await showPopup([
		['html', { html }]
	], {
